---
title: Exploring the Path of Open Source Development Together and Painting a New Blueprint for the Community —— A Wonderful Review of the 2025 Board Meeting of the OSS Compass Community
tags:
  - blog
---
...
At the beginning of the meeting, the election process of new members of the Community Board was officially launched. Liang Guanyu from the Institute of Software of the Chinese Academy of Sciences elaborated in detail on the scientific research strength and innovative achievements of the Institute of Software of the Chinese Academy of Sciences, and expounded in depth on the cooperation project plan with the Compass Community. His application proposal was unanimously recognized by all the members present and passed with a unanimous vote. Thus, Liang Guanyu officially represented the Institute of Software of the Chinese Academy of Sciences and joined the big family of the Compass Community. This will inject new vitality into the development of the Compass Community and lay a solid foundation for the in-depth cooperation between the two parties in the field of open source in the future.
...
Facing the opportunities and challenges of 2025, the Compass Community has formulated a clear development plan:

1. **Upgrading of the SaaS Service Matrix**  
   Five core services were grandly launched at the SaaS service layer, covering fields such as open-source situation insight service, community ecosystem evaluation service, developer profiling service, and developer selection evaluation service. By integrating the community's data resources and technical advantages, it provides users with one-stop and intelligent open-source service solutions, helping enterprises and developers accurately grasp the open-source trend and improve the management and decision-making efficiency of open-source projects.
...
In addition, in June 2025, the Compass Community will hold its annual summit at Peking University. At that time, the community will conduct in-depth discussions around the newly launched five SaaS services, and invite authoritative experts, representatives of enterprises and universities, and developers in the industry to gather together, share open-source practical experience, and discuss the future development of open source.

The successful convening of this Board meeting has pointed out the direction for the future development of the OSS-Compass Community. Standing at a new starting point, in the future, the OSS-Compass Community will join hands with all its members, drive development with innovation, and jointly write a new chapter in the open-source cause!
![2.png](media/2.png)
